...
const WORDS_BY_LEVEL = {
  1: [
    '나라', '이름', '머리', '아이', '나무', '이마', '라면', '마음', '어머니', '이리',
    '나란히', '어린이', '말리', '아리아', '나이', '아래', '이래', '마을', '나들이',
    '아이들', '이름표', '나라마다', '머나먼', '어린나이', '나란나란', '아리따운',
    '이마저', '말이야', '나름대로', '어머나',
  ],
  2: [
    '가방', '기차', '나비', '바다', '지구', '개나리', '노래', '지금', '배움', '가나다',
    '나비야', '기억', '도서관', '기분', '바지', '비행기', '책상', '지우개', '바람',
    '개나리꽃', '기억력', '도서관에', '자전거', '가방끈', '노래방', '지금부터',
    '비밀번호', '개구리', '나비잠', '바지런히',
  ],
  3: [
    '우리', '친구', '추억', '크레용', '트럭', '우주', '투명', '초록', '쿠키', '하늘',
    '구름', '학교', '우정', '추운', '크다', '우유', '치즈', '크레파스', '구름다리',
    '하늘나라', '우주여행', '친구들아', '학교가자', '추억이야', '투명인간',
    '초록불빛', '쿠키한개', '크게말해', '우정이란', '하늘위에',
  ],
  4: [
    '소망', '행복', '포기', '도전', '성장', '노력', '훌륭', '자랑', '함께', '꿈나무',
    '하늘색', '소중해', '용기있어', '희망차', '빛나는', '소중한하루', '행복해요',
    '포기말고', '도전장', '성장일기', '노력해요', '자랑스러운', '함께해요',
    '꿈을꾸자', '희망차게', '빛나는별', '용기내자', '하늘색꿈', '소망이야', '훌륭해',
  ],
}
