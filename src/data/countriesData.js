...
/**
 * 🚩 국기 퀴즈 난이도 — "쉬움" 풀(인지도 높은 50개국)
 *
 * 이름만 보관하고 실제 국기·데이터는 COUNTRIES/COUNTRIES_SET2에서 가져온다.
 * - 쉬움  : 아래 50개국만 출제
 * - 어려움: 전체 100여 개국(이 50개국 포함) 출제
 * 빼거나 더하려면 이 목록만 수정하면 된다.
 */
export const FLAG_EASY_COUNTRIES = new Set([
  // 아시아
  '일본', '중국', '인도', '인도네시아', '태국', '베트남', '필리핀', '싱가포르', '대만', '북한',
  // 중동
  '사우디아라비아', '이란', '이라크', '이스라엘', '터키', '카타르', '아랍에미리트',
  // 유럽
  '영국', '프랑스', '독일', '이탈리아', '스페인', '러시아', '그리스', '포르투갈', '네덜란드',
  '스웨덴', '노르웨이', '덴마크', '핀란드', '스위스', '오스트리아', '폴란드', '아일랜드', '벨기에', '우크라이나',
  // 아프리카
  '이집트', '모로코', '케냐',
  // 아메리카
  '미국', '캐나다', '멕시코', '브라질', '아르헨티나', '칠레', '페루', '쿠바', '콜롬비아',
  // 오세아니아
  '호주', '뉴질랜드',
])
